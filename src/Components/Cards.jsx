...
import card1 from '../Assets/stock.png';
import card2 from '../Assets/adresse.png';
import card3 from '../Assets/reclamation.png';
...
function Cards(){
    ...
    return(
        <div className='container'>
            <h1 className="p-5 border-bottom display-3">مرحبا فلان بن فلان</h1>
