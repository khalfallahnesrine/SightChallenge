				...
				<ul className="nav justify-content-center border-bottom ab-3 mb-3">
					<Link style={FooterStyles} to="/Home">
						<li className="nav-item">
							<a className="nav-link ax-2 text-muted">الصفحة الرئيسية</a>
						</li>
					</Link>
					<Link style={FooterStyles} to="/About">
						<li className="nav-item">
							<a className="nav-link ax-2 text-muted">تعرف عنا</a>
						</li>
					</Link>
					<Link style={FooterStyles} to="/Services">
						<li className="nav-item">
							<a className="nav-link ax-2 text-muted">الخدمات</a>
						</li>
					</Link>
					<Link style={FooterStyles} to="/Contact">
						<li className="nav-item">
							<a className="nav-link ax-2 text-muted">اتصل بنا</a>
						</li>
					</Link>
				</ul>
				<a
